    ...
    <>
      ...
      <section className="relative pt-40 pb-24 bg-primary overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-white/50 text-sm mb-4">
                ...
                {success ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <label htmlFor="full_name" className="block text-sm font-medium text-text-main mb-2">
            ...
            >
                ...
                <address className="not-italic space-y-5">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+233244274630" className="text-sm hover:text-accent transition-colors">
                        +233 244 27 4630
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    {[
                      ...
                      <a
                        key={label}
                        href="#"
                        aria-label={`Follow MG Reliance on ${label}`}
              ...
              <div className="rounded-2xl overflow-hidden border border-gray-100 h-64">
                <iframe
                  ...
                  title="MG Reliance Property Developers — East Legon, Accra, Ghana"
                />
              </div>
            </motion.div>
          </div>
